...
export class Backend implements backendInterface {
    ...
    async cleanupExpiredEntries(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.cleanupExpiredEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createShare(arg0: ExternalBlob, arg1: string, arg2: bigint, arg3: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createShare(await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg0), arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBlobReference(arg0: string): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.getBlobReference(arg0);
                return from_candid_ExternalBlob_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getFileInfo(arg0: string): Promise<{
        mimeType: string;
        fileName: string;
        fileSize: bigint;
        timestamp: Time;
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getFileInfo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ExternalBlob_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ExternalBlob): Promise<ExternalBlob> {
